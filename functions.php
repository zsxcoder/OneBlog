...
function themeConfig($form) {
    ...
    // 友链朋友圈配置
    $FriendCircleAPI = new Typecho_Widget_Helper_Form_Element_Text('FriendCircleAPI', NULL, 'https://fc.mcyzsx.top/', _t('友链朋友圈API地址'), _t('请填写友链朋友圈的API地址，默认为 https://fc.mcyzsx.top/'));
    $form->addInput($FriendCircleAPI);
    
    $FriendCirclePageSize = new Typecho_Widget_Helper_Form_Element_Text('FriendCirclePageSize', NULL, '15', _t('友链朋友圈每页数量'), _t('请填写每次加载的文章数量，默认为15。'));
    ...
    $X = new Typecho_Widget_Helper_Form_Element_Text('X', NULL, NULL, _t('X'), _t('请填写X（原Twitter）地址。'));
    $form->addInput($X);
    
    // $Twitter = new Typecho_Widget_Helper_Form_Element_Text('Twitter', NULL, NULL, _t('Twitter'), _t('请填写Twitter地址。'));
    // $form->addInput($Twitter);
    
    $BiliBili = new Typecho_Widget_Helper_Form_Element_Text('BiliBili', NULL, NULL, _t('BiliBili'), _t('请填写BiliBili主页地址。'));
